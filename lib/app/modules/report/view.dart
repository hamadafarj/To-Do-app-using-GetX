...
class ReportPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: SafeArea(child: Obx(() {
      var createdTasks = homeCtr.getTotalTask();
      var completedTasks = homeCtr.getTotalDoneTask();
      ...
      return ListView(
        children: [
          Padding(
            ...
            child: Text(
              "My Report",
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24.0.sp),
            ),
          ),
          Padding(
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildState(Colors.orange, completedTasks, "Comoleted"),
