...
class TaskCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final squarWidht = Get.width - 12.0.wp;
        ...
        child: Column(
          ...
          children: [
            StepProgressIndicator(
              totalSteps: homeCtr.isTodosEmpty(task)?1:task.todos!.length,
              currentStep: homeCtr.isTodosEmpty(task)?0:homeCtr.getDoneTodo(task),
              size: 5,
              padding: 0,
